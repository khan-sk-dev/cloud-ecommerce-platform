...
public record ProductRequest(Integer id, @NotNull(message = "Product name is required") String name,
                             ...
                             @NotNull(message = "Price category is required") Integer categoryId) {
